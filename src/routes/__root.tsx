...
function RootDocument({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="nl" className="dark" data-theme="dark" suppressHydrationWarning>
      ...
      <body
        className={[
          'font-sans antialiased [overflow-wrap:anywhere]',
          isWallRoute ? 'overflow-hidden' : '',
        ].join(' ')}
      >
